...
import { merge, rotateOutUpLeft, rollOut, bounceOutUp } from 'react-animations'

const leftUp = merge(rotateOutUpLeft, bounceOutUp)
const rightUp = merge( bounceOutUp, rollOut)
